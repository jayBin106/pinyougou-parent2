 ...
 * 4、登录成功后生成相应的auth code即授权码，然后重定向到客户端地址，如http://localhost:9080/oauth-client/oauth2-login?code=52b1832f5dff68122f4f00ae995da0ed；
...
//                authorizeService.addAuthCode(authorizationCode, username);
                shiroRedisUtils.set(AUTHORIZE + clientId, authorizationCode);
                shiroRedisUtils.set(AUTHUSER + authorizationCode, member);
            }
