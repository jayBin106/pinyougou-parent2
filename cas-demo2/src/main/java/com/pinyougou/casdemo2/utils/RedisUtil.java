package com.pinyougou.casdemo2.utils;
...
//    public void set(MiaoShaUserKey miaoShaUserKey, String key, String value) {
//        ValueOperations<String, String> ops = this.stringRedisTemplate.opsForValue();
//        String realKey = miaoShaUserKey.getPrefix() + key;
//        //如果不存在key设置
//        if (!this.stringRedisTemplate.hasKey(realKey)) {
//            int i = miaoShaUserKey.expireSeconds();
//            if (i <= 0) {
//                ops.set(realKey, value);
//            } else {
//                ops.set(realKey, value, miaoShaUserKey.expireSeconds(), TimeUnit.SECONDS);
//            }
//            System.out.println("redis的key设置成功");
//            System.out.println("key = " + ops.get(realKey));
//            System.out.println("过期时间 = " + stringRedisTemplate.getExpire(realKey));
//        } else {
//            //如果存在key更新过期时间
//            stringRedisTemplate.expire(realKey, miaoShaUserKey.expireSeconds(), TimeUnit.SECONDS);
//        }
//    }
    ...
    public void setMap(String mapString, String key, Object value) {
        ValueOperations<String, String> ops = this.stringRedisTemplate.opsForValue();
        HashOperations<String, Object, Object> opsForHash = stringRedisTemplate.opsForHash();
        if (!this.stringRedisTemplate.hasKey(mapString)) {
            opsForHash.put(mapString, key, beanToString(value));
            System.out.println("redis的key设置成功");
            System.out.println("this key = " + opsForHash.get(mapString, key));
        }
    }

    public Object getMap(String mapKey, String key) {
        HashOperations<String, Object, Object> opsForHash = stringRedisTemplate.opsForHash();
        return opsForHash.get(mapKey, key);
    }

    public Long delMap(String mapKey, String key) {
        HashOperations<String, Object, Object> opsForHash = stringRedisTemplate.opsForHash();
        Long delete = opsForHash.delete(mapKey, key);
        return delete;
    }
     ...
     * @return
     */
    public Long increment(String key, Object o) {
        Long aLong = Long.valueOf(o.toString());
        Long aDouble1 = this.stringRedisTemplate.boundValueOps(key).increment(aLong);
        return aDouble1;
    }
    ...
    public boolean lock(String key, String value) {
        //如果key不存在返回true,并设置，如果存在返回false
    ...
    public Boolean unlock(String key, String value) {
        //如果key存在，那就设置value,并获得之前的value,如果key不存在设置value.返回
    ...
    public String leftPop(String key) {
        String aLong = stringRedisTemplate.opsForList().rightPop(key);
        return aLong;
    }
