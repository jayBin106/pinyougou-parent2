...
app.service('specificationService', function ($http) {
    ...
    //增加
    this.addGroup = function (entity) {
        return $http.post('../specification/addGroup', entity);
    }
    //增加
    this.updateGroup = function (entity) {
        return $http.post('../specification/updateGroup', entity);
    }
    //修改
...
//查询实体
    this.selectOne = function (id) {
        return $http.get('../specification/selectOne?id=' + id);
    }
