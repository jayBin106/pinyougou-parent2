...
public class SpecificationController {
    ...
    public Result addGroup(@RequestBody Specification specification) {
        try {
            specificationGroupService.add(specification);
            return new Result(true, "增加成功");
        } catch (Exception e) {
            e.printStackTrace();
            return new Result(false, "增加失败");
    ...
    public Specification selectOne(long id) {
        return specificationGroupService.selectOne(id);
    }
    ...
    public Result updateGroup(@RequestBody Specification specification) {
        return specificationGroupService.updateGroup(specification);
    }
    /**
     * 规格下拉
     *
    ...
    public String selectOptionList() {
        ...
        for (TbSpecification o : all) {
            HashMap<String, String> map = new HashMap<>();
            map.put("id", o.getId().toString());
            map.put("text", o.getSpecName());
            maps.add(map);
        }
